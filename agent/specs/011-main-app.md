...
From the repository root, `make install` executes `go install ./cmd/apih` to
install this command into `GOBIN` when set or otherwise `$GOPATH/bin`.
The installation documentation and isolated verification belong to
[`018-readme-and-install`](../changes/018-readme-and-install.md).
